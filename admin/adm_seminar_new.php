...
<?php
  ...
  $cu = new utils();
?>
          <h1 class="page-header">Nuovo seminario</h1>
          <div class="row">
...
domenica ore 14:00 - 16:00 lezione</textarea>
            ...
            <div class="control-group col-md-6">
                        <label>note</label>
                        <div class="controls" >
                             <textarea class="form-control" name="notes" id="notes" maxlength="200" rows="3">Commenti e note</textarea>
                         </div>
                      </div> 
        </div>                    
                <hr>
