                  ...
                  <div class="control-group col-sm-6">
                    ...
                    <div class="form-group">
                      <div class='input-group date'>
                          <input type='text' class="form-control" id='date' name='date' value="<?php echo $db->db_to_date($s->date); ?>"/>
                    ...
                    <div class="row"> 
                      <div class="control-group col-md-12" >
                        <label>titolo (max 400 car.) <i class="fa fa-asterisk asterisc"></i></label>
                          <div class="controls">
                              <textarea class="form-control" id='title' name="title" maxlength="400"><?php echo $s->title; ?></textarea>
                          </div>
                      </div> 
                  </div>
                    <hr>
          ...
          <div class="control-group col-md-12">
                    <label><br/></label>
                        <div class="controls">
                          ...
                          <input type="submit" value="annulla" id="reset" name="annulla" class="btn btn-primary">
              </center>
                        </div>
                    </div>
